...
const routeDashboard = [
  ...
  createRoute(route("dashboard"), "get", "Saved Post", "bookmark"),
  createRoute(route("articles.create"), "get", "Create Post", "plus-square"),
  createRoute(route("dashboard"), "get", "Statistics", "bar-chart"),
  createRoute(route("profile"), "get", "Settings", "settings"),
